...
////// Emissive:
                ...
                float node_2298_ang = (3.141592654*_MaskE01_UVangle);
                float node_2298_spd = 1.0;
                float node_2298_cos = cos(node_2298_spd*node_2298_ang);
                float node_2298_sin = sin(node_2298_spd*node_2298_ang);
                float2 node_2298_piv = float2(0.5,0.5);
                float2 node_2298 = (mul(i.uv0-node_2298_piv,float2x2( node_2298_cos, -node_2298_sin, node_2298_sin, node_2298_cos))+node_2298_piv);
                float4 _MaskE01_var = tex2D(_MaskE01,TRANSFORM_TEX(node_2298, _MaskE01));
