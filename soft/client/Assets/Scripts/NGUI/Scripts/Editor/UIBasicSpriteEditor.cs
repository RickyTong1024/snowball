...
public class UIBasicSpriteEditor : UIWidgetInspector
{
	...
	protected override void DrawCustomProperties ()
	{
		...
		if (type == UISprite.Type.Simple)
		{
            ...
            NGUIEditorTools.DrawProperty("Round", serializedObject, "mRound", GUILayout.MinWidth(20f));
            GUILayout.BeginHorizontal();
            GUILayout.Space(4f);
            NGUIEditorTools.DrawProperty("RAmount", serializedObject, "mRoundAmount", GUILayout.MinWidth(20f));
            GUILayout.Space(4f);
