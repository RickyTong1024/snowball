...
public class UIInput : MonoBehaviour
{
    ...
    public string check_length(string str)
    {
        if (characterLimit <= 0)
        {
            return str;
        ...
        while (bytestr.Length > characterLimit)
        {
            str = str.Substring(0, str.Length - 1);
            bytestr = System.Text.Encoding.Default.GetBytes(str);
        }
        return str;
    }
	/// <summary>
	...
	public void Start ()
	{
        ...
        if (label != null)
        {
            label.color = new Color(126f / 255f, 144f / 255f, 164f / 255f, 1f);
        }
        hideInput = false;
        if (selectOnTab != null)
		{
