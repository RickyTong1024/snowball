...
public class UIBasicSpriteWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("roundAmount", get_roundAmount, set_roundAmount);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_roundAmount(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIBasicSprite obj = (UIBasicSprite)o;
			float ret = obj.roundAmount;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index roundAmount on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_roundAmount(IntPtr L)
	{
		object o = null;
