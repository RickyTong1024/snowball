...
public class UILabelWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetDefaultLanguage", SetDefaultLanguage);
		L.RegFunction("GetSides", GetSides);
		L.RegFunction("RefreshFontColor", RefreshFontColor);
	...
	static int SetDefaultLanguage(IntPtr L)
	{
		try
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int RefreshFontColor(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UILabel obj = (UILabel)ToLua.CheckObject<UILabel>(L, 1);
			obj.RefreshFontColor();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int GetCharacterIndexAtPosition(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Vector3, bool>(L, 2))
			{
				UILabel obj = (UILabel)ToLua.CheckObject<UILabel>(L, 1);
