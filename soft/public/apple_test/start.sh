...
cd ../../login_pipe
nohup python3 -u login_pipe.py snowball > nohup.out 2>&1 &
#cd ../libao_pipe
#nohup python3 -u libao_pipe.py &
#cd ../back_pipe
#nohup python3 -u back_pipe.py &
cd ../recharge_pipe
nohup python3 -u recharge_pipe.py snowball > nohup.out 2>&1 &
