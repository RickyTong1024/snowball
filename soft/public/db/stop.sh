...
kill $(ps -ef | grep 'python3 -u login_pipe'|awk '{print $2}')
#kill $(ps -ef | grep 'python3 -u back_pipe'|awk '{print $2}')
#kill $(ps -ef | grep 'python3 -u libao_pipe'|awk '{print $2}')
kill $(ps -ef | grep 'python3 -u recharge_pipe'|awk '{print $2}')
